...
class VProfileWin(VWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.bg.setText("")
        self.bg.setPixmap(QtGui.QPixmap("img/o_app_tlo.png"))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("img/profile_win/pokaz_przycisk.png"), QtGui.QIcon.Normal,
                        QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("img/profile_win/edytuj_przycisk.png"), QtGui.QIcon.Normal,
                        QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("img/profile_win/zapisz_przycisk.png"), QtGui.QIcon.Normal,
                        QtGui.QIcon.Off)
