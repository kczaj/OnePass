...
class VPasswordsListWin(VMainWin):
    ...
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("img/main_win_after/przycisk_notatki.png"), QtGui.QIcon.Normal,
                       QtGui.QIcon.Off)
        ...
        self.choose_button.setGeometry(QtCore.QRect(510, 540, 131, 31))
        self.choose_button.setText("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("img/pass_list_win/wybierz_button.png"), QtGui.QIcon.Normal,
                        QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("img/pass_list_win/dodaj_button.png"), QtGui.QIcon.Normal,
                        QtGui.QIcon.Off)
