...
class VNoteListWin(VMainWin):
    ...
    def setupUi(self, MainWindow):
        ...
        self.edit_button.setGeometry(QtCore.QRect(510, 540, 141, 31))
        self.edit_button.setText("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("img/note_list_win/edytuj_button.png"), QtGui.QIcon.Normal,
                        QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("img/note_list_win/dodaj_button.png"), QtGui.QIcon.Normal,
                        QtGui.QIcon.Off)
