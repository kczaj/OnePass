...
class VMainWinBefore(VWindow):
    ...
    def eventFilter(self, source, event) -> bool:
        if event.type() == QtCore.QEvent.HoverEnter and source is self.sign_in_button:
            ...
            icon_hovered_sign_in.addPixmap(QtGui.QPixmap("view/img/main_win_before/przycisk_zaloguj_hovered.png"),
                                           QtGui.QIcon.Normal,
                                           QtGui.QIcon.Off)
        ...
        if event.type() == QtCore.QEvent.HoverEnter and source is self.sign_up_button:
            ...
            icon_hovered_sign_up.addPixmap(QtGui.QPixmap("view/img/main_win_before/przycisk_zarejestruj_hovered.png"),
                                           QtGui.QIcon.Normal,
                                           QtGui.QIcon.Off)
        ...
        if event.type() == QtCore.QEvent.HoverLeave and source is self.sign_up_button:
            ...
            icon_sign_up.addPixmap(QtGui.QPixmap("view/img/main_win_before/przycisk_zarejestruj.png"),
                                   QtGui.QIcon.Normal,
                                   QtGui.QIcon.Off)
        ...
        if event.type() == QtCore.QEvent.HoverEnter and source is self.generate_button:
            ...
            icon_hovered_generate.addPixmap(QtGui.QPixmap("view/img/main_win_before/przycisk_generuj_hovered.png"),
                                            QtGui.QIcon.Normal,
                                            QtGui.QIcon.Off)
        ...
        if event.type() == QtCore.QEvent.HoverEnter and source is self.about_app_button:
            ...
            icon_hovered_about_app.addPixmap(QtGui.QPixmap("view/img/main_win_before/przycisk_oapp_hovered.png"),
                                             QtGui.QIcon.Normal,
                                             QtGui.QIcon.Off)
